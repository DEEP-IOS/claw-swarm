/**
 * 版本一致性检查 V5.5 / Version Consistency Check V5.5
 *
 * 自动验证所有版本号引用的一致性
 */
...
describe('Version Consistency', () => {
  const EXPECTED_VERSION = '5.5.0';
  const EXPECTED_NAME = 'Claw-Swarm V5.5';
  ...
  it('openclaw.plugin.json name should contain V5.5', () => {
    const content = JSON.parse(readFile('openclaw.plugin.json'));
    expect(content.name).toContain('V5.5');
  });
  ...
  it('install.js should reference V5.5', () => {
